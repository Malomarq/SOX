    ...
    <div class="container mb-5 px-5">
            ...
            <form @submit.prevent="buybag" class="row">
                <div class="col-12 col-md-6 col-sm-12 border mb-4 bg-light">
                    <div class="row my-4">
                        <div class="container">
                            ...
                            <div class="row my-5 mx-4 shipmban py-4 rounded shadow text-light">
                ...
                <div class="col-12 col-md-4 offset-md-2">
                    ...
                    <div class="col-12 col-md-12 bagborder pt-4 mb-4 mt-5 mt-sm-0">
                        <div class="row mb-4">
                            <div class="container">
                                <div class="row my-2">
                    ...
                    <div class="col-12 col-md-12 bg-light paymborder pt-4 mb-4 mt-5 mt-sm-0">
                        <div class="row mb-4">
                            <div class="container">
                                <div class="row my-2">
