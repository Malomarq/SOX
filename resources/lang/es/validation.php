...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'lastname' => ['max' => 'El apellido no puede contener más de :max caracteres'],
        'pass' => ['min' => 'La contraseña debe contener un mínimo de :min caracteres'],

        'newname' => ['max' => 'El nombre no puede contener más de :max caracteres'],
        'newprice' => ['regex' => 'El precio sólo puede estar entre tres posibles valores: 5.95€, 7.95€ y 10.95€'],
        'newimage' => ['image' => 'El archivo sólo puede ser de tipo imagen'],
    ],
    ...
    */
    ...
    'attributes' => ['name', 'lastname', 'pass', 'newname', 'newprice', 'newimage'],
